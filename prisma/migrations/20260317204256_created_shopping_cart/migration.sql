/*
  ...
  - You are about to drop the column `expired_date` on the `reset_token` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "reset_token" DROP COLUMN "expired_date",
